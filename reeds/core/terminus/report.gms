...
stor_energy_cap(i,v,r,t)$[tmodel_new(t)$valcap(i,v,r,t)] =
        storage_duration_m(i,v,r) * CAP.l(i,v,r,t) * (1$CSP_Storage(i) + 1$psh(i) + bcr(i)$pvb(i))
...
cap_firm(i,r,ccseason,t)$[valcap_irt(i,r,t)$[not consume(i)]$tmodel_new(t)$Sw_PRM_CapCredit] =
      sum{v$[(not vre(i))$(not hydro(i))$(not storage(i))$(not hybrid_plant(i)$(not csp(i)))$valcap(i,v,r,t)],
          CAP.l(i,v,r,t) 
...
* firm credit for the dispatchable generation side of storage-hybrid plants (matches eq_reserve_margin)
    + sum{v$[storage_hybrid_dispatchable(i)$valcap(i,v,r,t)],
          CAP.l(i,v,r,t)
          * (1 + ccseason_cap_frac_delta(i,v,r,ccseason,t))
          * (1 - mean_forced_outage_rate(i,r,ccseason,t))
         } ;
