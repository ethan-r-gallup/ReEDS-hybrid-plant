...
GEN_PLANT.lo(i,v,r,h,t_unfix)$[hybrid_plant(i)$(not csp(i))$valgen(i,v,r,t_unfix)$Sw_HybridPlant] = 0 ;
GEN_PLANT.up(i,v,r,h,t_unfix)$[hybrid_plant(i)$(not csp(i))$valgen(i,v,r,t_unfix)$Sw_HybridPlant] = +inf ;
GEN_STORAGE.lo(i,v,r,h,t_unfix)$[hybrid_plant(i)$(not csp(i))$valgen(i,v,r,t_unfix)$Sw_HybridPlant] = 0 ;
GEN_STORAGE.up(i,v,r,h,t_unfix)$[hybrid_plant(i)$(not csp(i))$valgen(i,v,r,t_unfix)$Sw_HybridPlant] = +inf ;
...
STORAGE_IN_PLANT.lo(i,v,r,h,t_unfix)$[valgen(i,v,r,t_unfix)$hybrid_plant(i)$(not csp(i))$Sw_HybridPlant] = 0 ;
STORAGE_IN_PLANT.up(i,v,r,h,t_unfix)$[valgen(i,v,r,t_unfix)$hybrid_plant(i)$(not csp(i))$Sw_HybridPlant] = +inf ;
STORAGE_IN_GRID.lo(i,v,r,h,t_unfix)$[valgen(i,v,r,t_unfix)$hybrid_plant(i)$(not csp(i))$Sw_HybridPlant] = 0 ;
STORAGE_IN_GRID.up(i,v,r,h,t_unfix)$[valgen(i,v,r,t_unfix)$hybrid_plant(i)$(not csp(i))$Sw_HybridPlant] = +inf ;
